export const goldUi = {
  vi: {
    ...
    'settle.err.kind': 'Chỉ phiếu mua vào, bán ra và đặt cọc mới thanh toán tiếp được.',
    ...
    'settle.depositOpen': 'Thêm tiền cọc',
    'settle.depositTitle': 'Thêm tiền cọc — {0}',
    'settle.depositAtCounter': 'Cọc lúc lập phiếu',
    'settle.depositLater': 'Các lần cọc thêm',
    'settle.depositNew': 'Ghi lần cọc thêm',
    'settle.depositSaved': 'Đã ghi thêm tiền cọc cho {0}',
    'txn.move.in': 'Nhập',
    'txn.move.out': 'Xuất',
  ...
  en: {
    ...
    'settle.err.kind': 'Only a purchase, a sale or a deposit can be paid later.',
    ...
    'settle.depositOpen': 'Add to the deposit',
    'settle.depositTitle': 'Add to the deposit — {0}',
    'settle.depositAtCounter': 'Put down with the order',
    'settle.depositLater': 'Added since',
    'settle.depositNew': 'Add to the deposit',
    'settle.depositSaved': 'Added to the deposit on {0}',
    'txn.move.in': 'In',
    'txn.move.out': 'Out',
    'pickup.open': 'Pick up',
